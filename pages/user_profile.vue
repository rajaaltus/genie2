      ...
      <v-col cols="12" md="9" lg="9">
        ...
        >
          ...
          <v-tab-item class="pt-1">
            ...
            <Experience :experiences="experiences" @new-experience="updateExperience" />
          ...
          <v-tab-item>
            ...
            >
              ...
              <v-card-text v-else class="px-3 py-4">
                <SettingsForm :userProfile="userProfile" @profile-update="reloadProfile()" />
              </v-card-text>
            </v-card>
...
export default {
  ...
  mounted () {
    ...
    if (this.userProfile===undefined) {
      Swal.fire({
        title: 'Alert',
        text: 'Your profile seems empty! Please wait... we create your basic profile first.',
        icon: 'info',
      ...
      this.$store.dispatch('user/addProfile', payload)
      .then(resp=>{
          console.log(resp);
        })
        .catch(e => {
  ...
  methods: {
    ...
    async reloadProfile() {
      ...
      await this.$store.dispatch("user/setUserProfile", { id: this.$store.state.auth.user.id })
        .then(resp=>{
