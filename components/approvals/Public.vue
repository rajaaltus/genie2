    ...
    <v-card class="mx-auto mb-1" outlined>
      <v-list-item three-line>
        <v-list-item-content>
          ...
          <p class="body-2">{{info.type}} on "{{info.program_name}}" given by {{info.faculty_name}} on {{ $moment(info.date).format("DD MMM YYYY") }} at {{info.place}}.</p>
          <p class="body-2"><b><u>Programme Name: </u></b>{{info.program_name}}</p>
          <p class="body-2"><b><u>Target Audience: </u></b>{{ info.target_audience }}</p>
